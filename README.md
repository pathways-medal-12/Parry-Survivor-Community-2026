...
# 🎮 Parry Survivor — Community Edition

**Time your parries, survive the swarm.**
...
Parry Survivor is a fast-paced survival action game where players fend off endless waves of enemies using precise parry timing and escalating abilities. This Community Edition is a standalone build packaged as a self-contained package, requiring no storefront or additional software. All content is included, and the game is ready to play immediately after extraction.

Players who enjoy skill-based survival action games and want a self-contained offline version playable immediately.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4540130/dba087e57de6231f3fbc4ebad329e3e95929baf9/ss_dba087e57de6231f3fbc4ebad329e3e95929baf9.1920x1080.jpg?t=1789376939" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4540130/7dea81b4212b9feba9252db48750a24c85d3a4ab/ss_7dea81b4212b9feba9252db48750a24c85d3a4ab.1920x1080.jpg?t=1789376939" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4540130/7ae547e3155290fd661b9bc8a9328ac64edac403/ss_7ae547e3155290fd661b9bc8a9328ac64edac403.1920x1080.jpg?t=1789376939" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🛡️ **Parry-Centric Combat** — Deflect enemy attacks with well-timed parries to turn defense into offense.
- 🌊 **Endless Survival Waves** — Face increasingly dense hordes that scale in difficulty over time.
- ⚡ **Ability Progression** — enable and stack upgrades between waves to build unique loadouts.
- 🎯 **Precision Timing Gameplay** — Skill-based mechanics reward reaction speed and pattern recognition.
- 🏆 **Score and Leaderboard System** — Track run performance and compete for high scores locally.
- 🎮 **Full Controller Support** — Play with keyboard and mouse or a gamepad with configurable inputs.
- 💾 **Offline Play** — Complete single-player experience playable entirely offline.
- 📦 **Self-Contained Package** — No additional software required — extract and run.
- 🎨 **Stylized Visuals** — Clean, readable art direction keeps hundreds of enemies visible on screen.
- ⏱️ **Quick Run Sessions** — Runs designed for short sessions with instant restarts.
...
| **Processor** | Intel Core i3-4160 / AMD equivalent | Intel Core i5-8400 / AMD Ryzen 5 2600 |
| **RAM** | 4 GB | 8 GB |
| **Graphics** | NVIDIA GeForce GTX 750 Ti / AMD Radeon R7 260X | NVIDIA GeForce GTX 1050 Ti / AMD Radeon RX 560 |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\ParrySurvivor\Saved`
